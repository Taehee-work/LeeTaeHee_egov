...
public class EmployerInfoVO {
	...
	public String toString() {
		return "EmployerInfoVO [EMPLYR_ID=" + EMPLYR_ID + ", ORGNZT_ID=" + ORGNZT_ID + ", USER_NM=" + USER_NM
				...
				+ ", CRTFC_DN_VALUE=" + CRTFC_DN_VALUE + ", SBSCRB_DE=" + SBSCRB_DE + ", getEMPLYR_ID()="
				+ getEMPLYR_ID() + ", getORGNZT_ID()=" + getORGNZT_ID() + ", getUSER_NM()=" + getUSER_NM()
				+ ", getPASSWORD()=" + getPASSWORD() + ", getEMPL_NO()=" + getEMPL_NO() + ", getIHIDNUM()="
				+ getIHIDNUM() + ", getSEXDSTN_CODE()=" + getSEXDSTN_CODE() + ", getBRTHDY()=" + getBRTHDY()
				+ ", getFXNUM()=" + getFXNUM() + ", getHOUSE_ADRES()=" + getHOUSE_ADRES() + ", getPASSWORD_HINT()="
				+ getPASSWORD_HINT() + ", getPASSWORD_CNSR()=" + getPASSWORD_CNSR() + ", getHOUSE_END_TELNO()="
				+ getHOUSE_END_TELNO() + ", getAREA_NO()=" + getAREA_NO() + ", getDETAIL_ADRES()=" + getDETAIL_ADRES()
				+ ", getZIP()=" + getZIP() + ", getOFFM_TELNO()=" + getOFFM_TELNO() + ", getMBTLNUM()=" + getMBTLNUM()
				+ ", getEMAIL_ADRES()=" + getEMAIL_ADRES() + ", getOFCPS_NM()=" + getOFCPS_NM()
				+ ", getHOUSE_MIDDLE_TELNO()=" + getHOUSE_MIDDLE_TELNO() + ", getGROUP_ID()=" + getGROUP_ID()
				+ ", getPSTINST_CODE()=" + getPSTINST_CODE() + ", getEMPLYR_STTUS_CODE()=" + getEMPLYR_STTUS_CODE()
				+ ", getESNTL_ID()=" + getESNTL_ID() + ", getCRTFC_DN_VALUE()=" + getCRTFC_DN_VALUE()
				+ ", getSBSCRB_DE()=" + getSBSCRB_DE() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
