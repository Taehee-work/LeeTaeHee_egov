        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <div class="default_tablestyle">
                    <table summary="번호,사용자 아이디,이메일,등급,등록일자,휴면계정	목록입니다" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th scope="col" nowrap="nowrap">사용자 아이디</th>
                        <th scope="col" nowrap="nowrap">이메일</th>
                        <th scope="col" nowrap="nowrap">등급</th>
                        <th scope="col" nowrap="nowrap">등록일자</th>
                        <th scope="col" nowrap="nowrap">휴면계정</th>
                    </tr>
                    </thead>
                    <tbody>                 
                    ...
                    <!-- loop 시작 -->                                
                      <tr>
			            ...
			            <td nowrap="nowrap">
			            <fmt:formatDate pattern="yyyy-MM-dd-HH:mm" value="${result.SBSCRB_DE}"/></td>
			            <td nowrap="nowrap">
