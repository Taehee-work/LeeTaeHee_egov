						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="form-group">
									<label>사용자 아이디</label>
									<input type="text" class="form-control" name="EMPLYR_ID" value="${memberVO.EMPLYR_ID}" readonly="">
								</div>
							</div>
							...
							<div class="col-sm-12">
								...
								<div class="form-group">
									<label>사용자 이름</label>
									<input type="text" class="form-control" name="USER_NM" value="${memberVO.USER_NM}" disabled="">
								</div>
							</div>
							...
							<div class="col-sm-12">
								...
								<div class="form-group">
									<label>집주소</label>
									<input type="text" class="form-control" name="HOUSE_ADRES" value="${memberVO.HOUSE_ADRES}" disabled="">
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
									<label>이메일</label>
									<input type="text" class="form-control" name="EMAIL_ADRES" value="${memberVO.EMAIL_ADRES}" disabled="">
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<label>소속기관</label>
									<input type="text" class="form-control" name="ORGNZT_ID" value="${memberVO.ORGNZT_ID}" disabled="">
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
									<label>휴면계정여부</label>
									<input type="text" class="form-control"	name="EMPLYR_STTUS_CODE" value="${memberVO.EMPLYR_STTUS_CODE}" disabled="">
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
									<label>등록일</label>
									<input type="text" class="form-control"	name="SBSCRB_DE" value="${memberVO.SBSCRB_DE}" disabled="">
								</div>
							</div>
							<div class="form-group">
							<div class="buttons">
